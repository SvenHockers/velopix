...
#[pyfunction]
pub fn compute_tracking_efficiency(
...
#[pyfunction]
pub fn print_validation_summary(py_events: Vec<&PyDict>, py_tracks: Vec<Vec<Track>>, verbose: bool) -> PyResult<()> {
    Python::with_gil(|py|{
...
#[pyfunction]
pub fn export_validation_to_json(py_events: Vec<&PyDict>, py_tracks: Vec<Vec<Track>>, verbose: bool) -> PyResult<PyObject> {    
    Python::with_gil(|py|{
...
#[pyfunction]
pub fn export_detailed_metrics_json(py_events: Vec<&PyDict>, py_tracks: Vec<Vec<Track>>, verbose: bool) -> PyResult<PyObject> {
    Python::with_gil(|py| {
        let mut total_tracks = 0;
        let mut total_ghosts = 0;
        let mut total_ghost_rate = 0.0;
